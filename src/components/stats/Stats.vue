      ...
      <div v-if="athleteStats" class="mt-6">
        <div class="flex">
          ...
          <div class="w-1/2">
            ...
            <div class="flex my-4">
              <div class="w-full">
                <StatItem :statName="'Rides'" :statValue="athleteStats.all_ride_totals.count" />
              </div>
            </div>
            <div class="flex mb-4">
              <div class="w-full">
                <StatItem :statName="'Distance'" :statValue="convertToMiles(athleteStats.all_ride_totals.distance)" />
              </div>
            </div>
            <div class="flex mb-4">
              <div class="w-full">
                <StatItem :statName="'Elevation'" :statValue="convertToFeet(athleteStats.all_ride_totals.elevation_gain)" />
              </div>
            </div>
            <div class="flex mb-4">
              <div class="w-full">
                <StatItem :statName="'Moving time'" :statValue="convertToTime(athleteStats.all_ride_totals.moving_time)" />
              </div>
            </div>
          </div>
        </div>
